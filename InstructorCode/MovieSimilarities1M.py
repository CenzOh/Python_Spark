# Lesson 49, instructor code. 
# This will work with the 1 million ratings movie script
import sys
from pyspark import SparkConf, SparkContext
from math import sqrt
#COmmands to run on EMR successfully + output results for Star Wars:
...
# data = sc.textFile("file:///c:/users/cenzo/sparkcourse/ml-1m/ratings.dat")
