### Lesson 19 Running word count of a book python code

Quick note is that since we split based on WORDS we get weird 'words' like click" and webpage, punctuation should not count.
The idea is combine words together doesnt matter aout capitilization or puncutaiton. 

```
(base) C:\Users\cenzo\SparkCourse>cd instructorcode

(base) C:\Users\cenzo\SparkCourse\InstructorCode>spark-submit word-count.py
Self-Employment: 1
Building 5
an 172
Internet 13
